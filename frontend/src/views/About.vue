<template>
  <div class="about">
    <div class="entire">
      ...
      <br>
      <formation :data="temp_formation" :key="this.change"></formation>        
    </div>
  </div>
</template>

<script>
import DDD from '../components/Formation.vue'
export default {
  components:{
    'formation': DDD
  },
  ...
  methods: {
    changeFormation: function changeFormation(event){
      this.temp_formation = event.target.value;
