<template>
    <div class="cont">
        ...
        <input class="form-control" type="text" placeholder="Please Input Comment" v-model="comment_value" class="input_comment" v-on:keyup.enter="submit_comment"><br>
        <button class="btn btn-primary" v-on:click="submit_comment" style="margin : 3px;">Apply comment</button>
